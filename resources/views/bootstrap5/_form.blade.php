    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('comments.store') }}">
            ...
            @if(isset($guest_commenting) && $guest_commenting)
                <div class="mb-3">
                    <label for="guest_name" class="form-label">@lang('comments::comments.enter_your_name_here')</label>
                    <input type="text"
                           id="guest_name"
                           name="guest_name"
                ...
                <div class="mb-3">
                    <label for="guest_email" class="form-label">@lang('comments::comments.enter_your_email_here')</label>
                    <input type="email"
                           id="guest_email"
                           name="guest_email"
            ...
            <div class="mb-3">
                <label for="comment-message" class="form-label">@lang('comments::comments.enter_your_message_here')</label>
