...
.cc-toolbar-left { display: flex; align-items: center; gap: 2px; }
.cc-tool-btn {
    background: none;
    border: none;
    cursor: pointer;
...
.cc-tool-btn:hover { background: #e0e0e0; color: #333; }
.cc-tool-sep { width: 1px; height: 16px; background: #d8d8d8; margin: 0 8px; flex-shrink: 0; }
.cc-submit-btn {
    background: #ea580c;
    color: #fff;
    border: none;
...
.cc-submit-btn:hover { background: #d24d0b; }
.cc-submit-btn:active { transform: scale(.97); }
.cc-error { color: #dc2626; font-size: 12px; margin-top: 5px; }
...
.cc-auth-title { font-size: 15px; font-weight: 700; margin: 0 0 6px; color: #111; }
.cc-auth-sub { font-size: 13px; color: #777; margin: 0 0 16px; }
.cc-auth-link {
...
.cc-auth-link:hover { background: #d24d0b; color: #fff; }

/* ── Divider ── */
.cc-divider { border: none; border-top: 1px solid #ebebeb; margin: 28px 0; }

/* ── Header ── */
.cc-header { display: flex; align-items: center; justify-content: space-between; margin-bottom: 24px; }
.cc-header-left { display: flex; align-items: center; gap: 9px; }
.cc-title { font-size: 17px; font-weight: 700; margin: 0; color: #111; }
.cc-count-badge {
    background: #ea580c;
    color: #fff;
    font-size: 11px;
...
.cc-sort-btn:hover { color: #111; }

/* ── Comments list ── */
.cc-list { display: flex; flex-direction: column; gap: 22px; }
.cc-empty { text-align: center; padding: 40px 0; color: #aaa; font-size: 14px; }

/* ── Comment item ── */
.cc-comment { position: relative; }
.cc-comment-inner { display: flex; gap: 14px; }

/* ── Avatar ── */
.cc-avatar-wrap { position: relative; flex-shrink: 0; width: 40px; height: 40px; }
.cc-avatar {
    width: 40px;
    height: 40px;
    border-radius: 50%;
...
.cc-meta { display: flex; align-items: center; gap: 8px; flex-wrap: wrap; margin-bottom: 5px; }
.cc-author {
    font-weight: 700;
    font-size: 14px;
    color: #111;
...
.cc-verified { color: #3b82f6; display: inline-flex; }
.cc-time { font-size: 12.5px; color: #999; }
.cc-pending-badge {
    background: #fef9c3;
    color: #854d0e;
    font-size: 10px;
...
/* ── Action row ── */
.cc-actions { display: flex; align-items: center; gap: 14px; flex-wrap: wrap; }
.cc-action-btn {
    display: inline-flex;
    align-items: center;
    gap: 5px;
...
.cc-action-btn:hover { color: #ea580c; }
.cc-action-btn.cc-reaction-active { color: #ea580c; font-weight: 600; }
.cc-action-btn[data-type="dislike"].cc-reaction-active { color: #64748b; }
...
.cc-dropdown.cc-open .cc-dropdown-menu { display: block; }
.cc-dropdown-item {
    display: block;
    width: 100%;
    text-align: left;
...
.cc-dropdown-item:hover { background: #f5f5f5; }
.cc-dropdown-item.cc-danger { color: #dc2626; }
...
.cc-inline-form.cc-open { display: block; }
.cc-inline-textarea {
    width: 100%;
    border: none;
    background: transparent;
...
.cc-inline-textarea::placeholder { color: #aaa; }
.cc-inline-footer { display: flex; justify-content: flex-end; gap: 8px; }
.cc-cancel-btn {
    background: none;
...
.cc-cancel-btn:hover { background: #ececec; }
...
/* ── Show more ── */
.cc-show-more { text-align: center; margin-top: 28px; }
.cc-show-more-link {
    display: inline-flex;
    align-items: center;
    gap: 5px;
...
.cc-show-more-link:hover { color: #c2410c; }

/* ── Responsive ── */
@media (max-width: 520px) {
    .cc-wrap { padding: 20px 16px; }
    .cc-guest-fields { grid-template-columns: 1fr; }
    .cc-replies { margin-left: 36px; padding-left: 24px; }
    .cc-elbow   { left: -24px; width: 18px; }
    .cc-replies > .cc-comment:last-child::after { left: -26px; }
}
</style>
...
(function () {
    ...
    document.addEventListener('click', function (e) {
        ...
        var allReactBtns = commentEl
            ...
            : [];
        allReactBtns.forEach(function (b) { b.disabled = true; });
        ...
        .finally(function () {
            allReactBtns.forEach(function (b) { b.disabled = false; });
        });
    });
})();
</script>
