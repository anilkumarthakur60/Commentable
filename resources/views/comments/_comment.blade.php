            ...
            <div class="cc-actions">
                ...
                @can('reply-to-comment', $comment)
                    <button
                        ...
                        title="Reply"
                    >
                        <svg width="15" height="15" fill="currentColor" viewBox="0 0 24 24"><path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 14H6l-2 2V4h16v12z"/></svg>
                        Reply
                    </button>
                @endcan
                        ...
                        <div class="cc-dropdown-menu">
                            ...
                            @can('delete-comment', $comment)
                                ...
                                >
                                    @method('DELETE')
                                    @csrf
                                    <button type="submit" class="cc-dropdown-item cc-danger">@lang('comments::comments.delete')</button>
                                </form>
                            @endcan
                        </div>
                    </div>
